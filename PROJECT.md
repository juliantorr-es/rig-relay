...
[DIRECTIVE] Checkpoint Publication and Review: Local checkpoint commits preserve proven mission-owned work sets. Once the lane's release summary is published and a named milestone grants publication authorization, the lane must push its checkpointed commits for remote review. Publication is separate from authorship, and it does not widen the lane's claim or reopen frozen work. Review tooling may inspect only the published checkpointed slice; unrelated or deferred seams remain deferred unless the released boundary becomes unsafe or false.

[DIRECTIVE] Release Summary Quality: Every final lane summary must say what changed, which choices were made and why, what codebase research was performed, what external sources were consulted if any, and how that evidence supported the conclusion. The summary should explain the reasoning without becoming a transcript.
