...
from rig_relay.core.tools.base import BaseTool, BaseToolConfig
from rig_relay.core.tools.connectors import ConnectorRegistry
from rig_relay.core.tools.mcp import MCPRegistry
from rig_relay.core.tools.mcp.tools import MCPTool
from rig_relay.core.utils import name_matches, run_sync
...
def _try_canonical_module_name(path: Path) -> str | None:
    ...
    try:
        vibe_idx = parts.index("rig-relay")
    except ValueError:
        return None
