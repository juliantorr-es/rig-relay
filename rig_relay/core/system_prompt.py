...
from rig_relay.core.utils import is_dangerous_directory, is_windows

if TYPE_CHECKING:
    from rig_relay.core.agents import AgentManager
    from rig_relay.core.config import ProjectContextConfig, VibeConfig
...
def _add_commit_signature() -> str:
    return (
        "When explicitly asked to commit, use a normal git commit message. "
