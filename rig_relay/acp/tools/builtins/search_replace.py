...
from rig_relay.acp.tools.base import AcpToolState, BaseAcpTool
...
from rig_relay.core.utils.io import ReadSafeResult
...
class SearchReplace(CoreSearchReplaceTool, BaseAcpTool[AcpSearchReplaceState]):
    ...
    prompt_path = (
        RIG_ROOT / "core" / "tools" / "builtins" / "prompts" / "search_replace.md"
    )
