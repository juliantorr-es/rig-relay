...
class TestPlayback:
    @patch("rig_relay.core.audio_player.audio_player.sd.RawOutputStream")
...
class TestGuardAudioOutput:
    def test_raises_when_no_sounddevice(self) -> None:
        with patch("rig_relay.core.audio_player.audio_player.sd", None):
            player = AudioPlayer()
    ...
    def test_raises_when_no_output_device(self, mock_stream_cls: MagicMock) -> None:
        with patch(
            "rig_relay.core.audio_player.audio_player.sd.query_devices",
