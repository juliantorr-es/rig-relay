"""Governance artifact test for GitHub App permission posture."""
...
def test_github_app_permission_posture_artifact_validates_and_stays_content_light():
    ...
    assert report["schema_version"] == "rig.github_app_permission_posture.v1"
