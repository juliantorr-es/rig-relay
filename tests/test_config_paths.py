...
def test_get_vibe_home_prefers_rig_relay_home_env(monkeypatch: pytest.MonkeyPatch, tmp_path: Path):
...
def test_get_vibe_home_falls_back_to_vibe_home_env(monkeypatch: pytest.MonkeyPatch, tmp_path: Path):
...
def test_get_vibe_home_prefers_existing_rig_relay_dir(monkeypatch: pytest.MonkeyPatch, tmp_path: Path):
    monkeypatch.delenv("RIG_RELAY_HOME", raising=False)
    ...
    monkeypatch.setattr("vibe.core.paths._vibe_home._LEGACY_RIG_RELAY_HOME", rr_legacy_dir)
...
def test_get_vibe_home_falls_back_to_legacy_rig_relay_dir(monkeypatch: pytest.MonkeyPatch, tmp_path: Path):
    monkeypatch.delenv("RIG_RELAY_HOME", raising=False)
    monkeypatch.delenv("VIBE_HOME", raising=False)
...
def test_get_vibe_home_falls_back_to_existing_vibe_dir(monkeypatch: pytest.MonkeyPatch, tmp_path: Path):
    monkeypatch.delenv("RIG_RELAY_HOME", raising=False)
    monkeypatch.delenv("VIBE_HOME", raising=False)
...
def test_get_vibe_home_defaults_to_rig_relay_for_new_install(monkeypatch: pytest.MonkeyPatch, tmp_path: Path):
    monkeypatch.delenv("RIG_RELAY_HOME", raising=False)
    monkeypatch.delenv("VIBE_HOME", raising=False)
