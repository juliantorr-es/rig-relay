...
| `task` | `builtins.task` | `nondeterministic_provider` | `writes_workspace` | Medium | Low | Full (provider/model/thinking metadata + deterministic task-result hash + task_session_link artifact) |
